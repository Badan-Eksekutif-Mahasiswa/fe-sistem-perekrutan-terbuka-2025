...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'text-white rounded-[12px] border border-primary-300',
  secondary:
    'bg-marun text-white rounded-[12px] drop-shadow-[0px_2px_4px_rgba(0,0,0,0.25)]',
  external:
    'text-primary-500 rounded-[12px]',
  signin:
    'bg-pink-light text-marun rounded-[12px] border border-marun',
};
...
export default function Button({
  ...
  const baseClasses = cn(
    'inline-flex items-center justify-center font-jakarta font-semibold transition-all duration-200 whitespace-nowrap',
