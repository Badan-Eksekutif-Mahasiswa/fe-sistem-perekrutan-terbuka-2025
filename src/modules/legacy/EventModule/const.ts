export const timelineData = [
  {
    ...
    desc: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis fuga quaerat corporis voluptatem eos architecto, ut dignissimos sed, amet laboriosam, dolorum itaque? Officia, quaerat architecto. Tempora laudantium esse officia animi.",
  },
  {
    date: new Date(),
    title: "Pendaftaran Batch 1",
...
export const divisiData = [
  {
    nama: "Multimedia",
    desc: "Divisi yang berfokus pada pengembangan seluruh kebutuhan visual dan audiovisual organisasi. Mulai dari dokumentasi kegiatan, pembuatan konten grafis, hingga pengelolaan aset digital agar identitas organisasi tersampaikan dengan baik. Divisi ini menjadi ujung tombak dalam memastikan setiap publikasi memiliki kualitas estetika yang konsisten dan profesional.",
    jobdesc:
  ...
  {
    nama: "Humas",
    desc: "Divisi yang bertanggung jawab menjaga citra organisasi melalui komunikasi yang strategis dengan pihak internal maupun eksternal. Fokusnya adalah membangun hubungan yang berkelanjutan dengan mitra, media, dan publik, sehingga organisasi dapat dikenal secara positif dan kredibel.",
    jobdesc:
  ...
  {
    nama: "Kewirausahaan",
    desc: "Divisi yang mengatur seluruh aspek bisnis internal organisasi, termasuk perencanaan usaha, pelaksanaan kegiatan komersial, dan evaluasi kinerja finansial. Divisi ini menjadi motor penggerak keberlanjutan finansial organisasi melalui inovasi dan pengelolaan pendapatan yang efektif.",
    jobdesc:
  ...
  {
    nama: "PSDM",
    desc: "Divisi yang berfokus pada pembinaan dan pengembangan kualitas anggota organisasi. Mulai dari penguatan soft skill, peningkatan karakter, hingga pengelolaan siklus keanggotaan. Tujuannya adalah menciptakan lingkungan organisasi yang suportif, produktif, dan berorientasi pada pertumbuhan.",
    jobdesc:
  ...
  {
    nama: "Acara",
    desc: "Divisi yang bertanggung jawab atas perencanaan, pengembangan konsep, dan pelaksanaan seluruh kegiatan formal maupun non-formal organisasi. Divisi ini memastikan setiap acara berjalan sesuai target, teratur, dan memberi dampak yang maksimal bagi peserta.",
    jobdesc:
  ...
  },
  {
    ...
    desc: "Divisi yang mengelola seluruh kebutuhan administrasi organisasi, termasuk dokumentasi, surat menyurat, dan pengarsipan. Divisi ini memastikan setiap kegiatan memiliki catatan lengkap dan terstruktur sehingga proses organisasi berjalan tertib dan terdokumentasi dengan baik.",
    jobdesc:
  ...
  {
    nama: "Keamanan",
    desc: "Divisi yang memastikan seluruh kegiatan organisasi berjalan dengan aman, terkontrol, dan minim risiko. Divisi ini mengambil peran penting dalam menjaga ketertiban acara serta mengantisipasi potensi gangguan selama kegiatan berlangsung.",
    jobdesc:
  ...
  {
    nama: "IT",
    desc: "Divisi yang menangani seluruh aspek teknologi informasi dan sistem digital organisasi. Mulai dari pengelolaan website, pengembangan aplikasi internal, hingga memastikan infrastruktur IT dapat digunakan dengan lancar oleh seluruh anggota.",
    jobdesc:
  ...
  {
    nama: "Kreatif",
    desc: "Divisi yang menjadi pusat ide dan inovasi visual organisasi. Fokusnya adalah menghasilkan konsep kreatif yang segar dan menarik untuk mendukung identitas organisasi dalam berbagai media dan kampanye.",
    jobdesc:
  ...
  {
    nama: "Riset & Analisis",
    desc: "Divisi yang bertugas mengumpulkan, mengolah, dan menganalisis data untuk mendukung proses pengambilan keputusan strategis dalam organisasi. Divisi ini menjadi fondasi dari perencanaan program yang berbasis data dan kebutuhan nyata.",
    jobdesc:
