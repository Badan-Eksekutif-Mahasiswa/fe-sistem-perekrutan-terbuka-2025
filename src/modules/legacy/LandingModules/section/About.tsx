        ...
        <div className="flex max-lg:flex-col-reverse justify-between gap-8 items-center rounded-3xl border border-primary-300 w-full p-6 max-lg:p-4 bg-gradient-card-blue backdrop-blur-sm" style={{ boxShadow: 'var(--shadow-glass)' }}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-p4 max-lg:text-justify">
              SPT (Sistem Perekrutan Terbuka) adalah platform rekrutmen resmi BEM UI 2026
              yang dirancang untuk mempermudah proses pendaftaran kepanitiaan dan staf di
              lingkungan Universitas Indonesia. Semua informasi rekrutmen, timeline, dan
              proses seleksi tersedia dalam satu tempat yang transparan dan mudah diakses
              oleh seluruh IKM UI.
            </p>
          </div>
        </div>
