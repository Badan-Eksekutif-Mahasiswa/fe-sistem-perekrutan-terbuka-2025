...
import { DSFilterCard, DSEventCard, EventGrid } from "@/design-system";
...
const getBadgeStatus = (status: string) => {
  if (status === 'Dibuka') return 'open';
  if (status === 'Ditutup') return 'closed';
  if (status === 'Akan Datang') return 'upcoming';
  return 'draft';
};

const EventModuleV2 = ({ events }: PendaftaranModuleProps) => {
  ...
  return (
    <main className="min-h-screen relative pt-32">
      <div className="absolute inset-0 bg-gradient-page -z-30 pointer-events-none" />
      ...
      <div className="px-5 py-10 md:px-20 text-center gap-5 justify-center text-white flex flex-col">
        ...
        <div className="flex flex-col relative max-md:justify-center max-md:items-center lg:flex-row gap-5 w-full">
          <DSFilterCard
            sections={filterCategory.map(c => ({ title: c.type, options: [...c.categories] }))}
            ...
            >
              ...
              <div className="flex w-full gap-2.5">
                ...
                <Button
                  ...
                  className="bg-linear-to-r from-marun-light to-marun text-white rounded-xl w-16 font-bold md:w-28 hover:brightness-110"
                >
